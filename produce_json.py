...
def select_data(dataset_name, table_name, sqlite_file, json_file, instruction="Answer the question."):
    ...
    input_output_pairs = [{'instruction': instruction,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--instruction", default="Answer the question.", nargs='?', help="Any dataset specific instruction")
    args = parser.parse_args()

    # Call the function with provided arguments
    select_data(args.dataset_name, args.table_name, args.sqlite_file, args.json_file, args.instruction)
